...
angular.module('task2.project').service('BoardService', ['$uibModal', 'BoardManipulator', function ($uibModal, BoardManipulator) {
  ...
  return {
    ...
    addNewCard: function (board, column) {
      var modalInstance = $uibModal.open({
        templateUrl: 'projects/partials/newCard.html',
